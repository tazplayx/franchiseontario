  ...
  try {
    ...
    const html = `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#f9fafb;border-radius:12px">
        <div style="background:#00228e;color:#fff;padding:16px 24px;border-radius:8px 8px 0 0;margin:-24px -24px 24px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:14px;margin-bottom:20px">
          ...
          <tr><td style="padding:8px 0;color:#6b7280">Source URL</td><td style="padding:8px 0"><a href="${sourceListingUrl}" style="color:#00228e">${sourceListingUrl}</a></td></tr>
          ...
          <tr><td style="padding:8px 0;color:#6b7280">Email</td><td style="padding:8px 0"><a href="mailto:${claimantEmail}" style="color:#00228e">${claimantEmail}</a></td></tr>
        ...
        <a href="https://www.franchiseontario.com/admin/claims" style="display:inline-block;background:#00228e;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:600;font-size:14px">
